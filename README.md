...
2. Теперь нужно установить Docker. Поскольку команды в нем набирать вручную 
   ...
   - Теперь скачайте себе на рабочий стол файл 
   ...
   Если вы все правильно сделали на предыдущих шагах, вы увидите что-то такое:
   ...
   - Теперь время вернуться в терминал в предыдущей вкладке браузера (мы ушли 
     ...
     запустим сам скрипт. Вводите по одной строчку и запускайте.
     ```
